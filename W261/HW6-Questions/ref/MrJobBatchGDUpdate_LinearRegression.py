...
class MrJobBatchGDUpdate_LinearRegression(MRJob):
    ...
    def read_weightsfile(self):
        # Read weights file
        localpath = '/Users/leiyang/GitHub/mids/w261/HW6-Questions/ref/weights.txt'
    ...
    def partial_gradient(self, _, line):
        ...
        self.partial_Gradient =  [self.partial_Gradient[0]+ y_hat-D[0], self.partial_Gradient[1]+(y_hat-D[0])*D[1]]
